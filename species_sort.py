...
stockable_species_dic = {'사육 가능성': ['돼지', '소', '말과', '산양', '면양', '면양/산양', '벌(벌집)', '조류', '버팔로', '고양이', '낙타과', '개', '토끼']}
