...
def get_oie_data():
    ...
    for new_linknumber in tqdm(new_linknumbers[11:15]):  # tqdm: 반복문에서의 리스트 원소 수를 백분율로 나타내어 진행표시줄을 만듦
        BOT = OieSubPage()
    ...
    want_columns = ['Link number',
                    ...
                    'Vaccination in response to the outbreak (s)','Surveillance outside containment and or protection zone',
                    'Surveillance within containment and or protection zone','Screening',
